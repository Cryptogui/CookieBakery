 ...
 * 
 *TODO: anv�nda try, catch f�r ny tab/chord row ist�llet f�r en counter?		(fixat f�r chord row nu)
 *
 *TODO: nytt random object f�r varje g�ng ist�llet f�r samma rand?
 */
